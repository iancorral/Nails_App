// src/components/layout/MuralDecorations.tsx
"use client";
...
export default function MuralDecorations() {
  return (
    <div className="fixed inset-0 pointer-events-none z-0 overflow-hidden font-sans">
      ...
      {/* ==================================================================================
          CAPA 1: ATMÓSFERA ORGÁNICA (Manchas de Tu Paleta)
          Usamos tus colores exactos con opacidad media para que se noten pero no lastimen.
      ================================================================================== */}

      {/* 1. Mancha Superior Derecha: TERRACOTA (Cálido y fuerte) */}
      ...
      {/* 2. Mancha Inferior Izquierda: LAVANDA (Rosa Mexicano suave) */}
      ...
      {/* ==================================================================================
          CAPA 2: ELEMENTOS DE TIERRA (Cenefas y Plantas)
          Aquí usamos el OLIVO y el CAFÉ para dar estructura.
      ================================================================================== */}

      {/* Cenefa Curva: OLIVO (Verde Nopal) */}
      <div className="absolute bottom-0 left-0 w-full z-10">
       ...
       {/* Cenefa Curva Segunda Capa: TERRACOTA (Arcilla) */}
      ...
      {/* ==================================================================================
          CAPA 3: DIBUJOS VECTORIALES (Detalles finos)
      ================================================================================== */}
      
      {/* Enredadera Izquierda: OLIVO (Verde) */}
